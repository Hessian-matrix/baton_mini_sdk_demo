...
void get_device_param(){
    ...
    std::cout << "fx: " << baton_cam_param.left_cam.fx << std::endl;
    std::cout << "fy: " << baton_cam_param.left_cam.fy << std::endl;
    std::cout << "cx: " << baton_cam_param.left_cam.cx << std::endl;
    std::cout << "cy: " << baton_cam_param.left_cam.cy << std::endl;
    std::cout << "xi: " << baton_cam_param.left_cam.xi << std::endl;
    std::cout << "alpha: " << baton_cam_param.left_cam.alpha << std::endl;

    std::cout << "baton_right_instrinsic: \n";
    std::cout << "fx: " << baton_cam_param.right_cam.fx << std::endl;
    std::cout << "fy: " << baton_cam_param.right_cam.fy << std::endl;
    std::cout << "cx: " << baton_cam_param.right_cam.cx << std::endl;
    std::cout << "cy: " << baton_cam_param.right_cam.cy << std::endl;
    std::cout << "xi: " << baton_cam_param.right_cam.xi << std::endl;
    std::cout << "alpha: " << baton_cam_param.right_cam.alpha << std::endl;

    std::cout << "baton_right2left_extrinsic: \n";
    std::cout << "px: " << baton_cam_param.extrinsic.px << std::endl;
    std::cout << "py: " << baton_cam_param.extrinsic.py << std::endl;
    std::cout << "pz: " << baton_cam_param.extrinsic.pz << std::endl;
    std::cout << "qx: " << baton_cam_param.extrinsic.qx << std::endl;
    std::cout << "qy: " << baton_cam_param.extrinsic.qy << std::endl;
    std::cout << "qz: " << baton_cam_param.extrinsic.qz << std::endl;
    std::cout << "qw: " << baton_cam_param.extrinsic.qw << std::endl;

    std::cout << "baton_camL2I_extrinsic: \n";
    std::cout << "px: " << baton_camL2I_extrinsic.px << std::endl;
    std::cout << "py: " << baton_camL2I_extrinsic.py << std::endl;
    std::cout << "pz: " << baton_camL2I_extrinsic.pz << std::endl;
    std::cout << "qx: " << baton_camL2I_extrinsic.qx << std::endl;
    std::cout << "qy: " << baton_camL2I_extrinsic.qy << std::endl;
    std::cout << "qz: " << baton_camL2I_extrinsic.qz << std::endl;
    std::cout << "qw: " << baton_camL2I_extrinsic.qw << std::endl;
    std::cout << "==========================================================\n";
}
